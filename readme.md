...
### Features
- Download illustrations, manga (PNG/JPG), novels (TXT), and ugoira (GIF/ZIP)
- Download illustrations by tag
- Download an artist's illustrations
- Download an artist's bookmarks
- Integrated browser
- Automatically translate titles to English
- Customize the output file names
- Map illustrations to sub-folders based on certain tags
- If you have Pixiv Premium you can return results by popularity
...
You can map images with certain tags into a subfolder. The folder mapping must be
...
For better accuracy provide the tags in Japanese, but they will be automatically translated if you have the translate option enabled.
